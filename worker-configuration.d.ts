/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 60125535640adf56aeb9a4781eaceff6)
// Runtime types generated with workerd@1.20250604.0 2025-06-20 
declare namespace Cloudflare {
	interface Env {
		"kv-database": KVNamespace;
		x_api_key: string;
		base_url: string;
		session: string;
		...
		base_url_name: SecretsStoreSecret;
		session_name: SecretsStoreSecret;
		openrouter_key: SecretsStoreSecret;
	}
}
